...
<table style="align: center; text-align: center; width: 95%;" align="center" border="1"
	...
	<tr style="color: maroon; font-size: 35px">
		<td colspan="4">Morphological Analysis Results
		</td>
	</tr>
<%
...
%>
	...
	<tr style="background-color: rgb(102, 0, 0); color: white">
		...
		<td><b>Analysed Word</b></td>
		<td><b>Morphological Feature</b></td>
	</tr>
	<%
		ArrayList<String> wordTags = new ArrayList<String>(
			...
			for (String wordTag : wordTags) {
				...
				analysis = morphResults.get(wordTag);
				if (analysis.contains("\t")) {
					analWord = analysis
							.substring(0, analysis.indexOf("\t"));
					analMorph = analysis
	...
	<tr style="color: maroon">
		<td><b><%=word%></b></td>
		<td><b><%=pos%></b></td>
		<td style="word-wrap: break-word; color: navy;"><b><%=analWord%></b></td>
		<td style="word-wrap: break-word; color: navy;"><%=analMorph%></td>
	</tr>
	<%
		}
	%>
...
%>
<tr>
		<td colspan = "4" style="color: maroon; font-size: 20px" >Thanks for using the Magahi Morph Analyser! Do give us your feedback and come back again!!</td>
	</tr> 
